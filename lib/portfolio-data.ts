    ...
    anime: [
      {
        ...
        url: "https://myanimelist.net/anime/55791",
      },
      {
        id: 47194,
        title: "Summertime Render",
        titleEnglish: "Summer Time Rendering",
        imageUrl: "/anime/mal-47194.jpg",
        episodesWatched: 25,
        totalEpisodes: 25,
        score: 8,
        status: "completed",
        isFavorite: true,
        genres: ["Mystery", "Supernatural", "Suspense", "Action"],
      ...
      },
      {
        ...
        imageUrl: "/anime/mal-1535.jpg",
        episodesWatched: 37,
        totalEpisodes: 37,
        score: 8,
        status: "completed",
        isFavorite: true,
        genres: ["Supernatural", "Suspense", "Mystery", "Psychological"],
        url: "https://myanimelist.net/anime/1535",
      },
      {
        id: 51019,
        title: "Kimetsu no Yaiba: Katanakaji no Sato-hen",
        titleEnglish: "Demon Slayer: Swordsmith Village Arc",
        imageUrl: "/anime/mal-51019.jpg",
        episodesWatched: 11,
        totalEpisodes: 11,
        score: 9,
        status: "completed",
      ...
      },
      {
        ...
        imageUrl: "/anime/mal-28851.jpg",
        episodesWatched: 1,
        totalEpisodes: 1,
        score: 10,
        status: "completed",
        isFavorite: true,
        genres: ["Award Winning", "Drama", "Romance", "Slice of Life"],
      ...
      },
      {
        ...
        imageUrl: "/anime/mal-52034.jpg",
        episodesWatched: 11,
        totalEpisodes: 11,
        score: 9,
        status: "completed",
        isFavorite: true,
        genres: ["Award Winning", "Drama", "Mystery", "Psychological"],
      ...
      },
      {
        ...
        imageUrl: "/anime/mal-38000.jpg",
        episodesWatched: 26,
        totalEpisodes: 26,
        score: 9,
        status: "completed",
        isFavorite: true,
        genres: ["Action", "Award Winning", "Supernatural", "Adventure"],
        url: "https://myanimelist.net/anime/38000",
      },
      {
        id: 47778,
        title: "Kimetsu no Yaiba: Yuukaku-hen",
        titleEnglish: "Demon Slayer: Entertainment District Arc",
        imageUrl: "/anime/mal-47778.jpg",
        episodesWatched: 11,
        totalEpisodes: 11,
        score: 9,
        status: "completed",
      ...
      },
      {
        ...
        imageUrl: "/anime/mal-40748.jpg",
        episodesWatched: 24,
        totalEpisodes: 24,
        score: 6,
        status: "completed",
        isFavorite: false,
        genres: ["Action", "Award Winning", "Supernatural", "Drama"],
