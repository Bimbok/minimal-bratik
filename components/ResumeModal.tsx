...
export const ResumeModal: React.FC = () => {
  ...
  }, [resumeOpen, isAdmin, liveResumes]);
        ...
        >
          <div ref={contentRef} className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="relative w-full h-[64vh] sm:h-[70vh] rounded-xl overflow-hidden border border-neutral-800 bg-neutral-950 shadow-2xl">
                <iframe
